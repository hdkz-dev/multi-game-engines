...
- **Current (measured 2026-05-10, after PR #140–#155)**: lines **98.01%** / statements **97.6%** / branches **88.05%** / functions **94.4%** — **98% threshold cleared**. Down from 98.41% at PR #49 to 84.6% on 2026-05-09; PR #140–#155 (14 PRs) recovered 13.41 points. The remaining ~0.39 pts are concentrated in `EngineFacade` (dispose-timing micro-edges) and `ResourceInjector` (worker-scope detection); tracked in TASKS.md.
