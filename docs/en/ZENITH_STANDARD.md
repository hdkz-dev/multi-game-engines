...
- **Current (measured 2026-05-11, after PR #140–#161)**: lines **98.45%** / statements **98.01%** / branches **89.05%** / functions **94.4%** ✅ **target met**. Down from 98.41% at PR #49 to 84.6% on 2026-05-09; PR #140–#161 recovered 13.85 points, exceeding the original target by +0.05 pt. CI pins thresholds at `lines ≥98.4 / branches ≥88` (PR #161); the Coverage Restoration backlog is fully closed.
