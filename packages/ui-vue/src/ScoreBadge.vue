...
import { EvaluationScore, EvaluationPresenter } from '@multi-game-engines/ui-core';
...
const colorClass = computed(() => EvaluationPresenter.getColorClass(props.score, props.inverted));
const label = computed(() => {
  if (props.score.type === 'mate') {
    return strings.value.mateIn(Math.abs(props.inverted ? -props.score.value : props.score.value));
  }
